...
// COMPRAR SI EL USUARIO TIENE ACCESO
restringirAccesoPagina();

// OBTENER DATOS PRINCIPALES
$usuarios = mostrarUsuarios(false);
$categorias = mostrarCategorias(false);
$productos = mostrarProductos('', [], '', null, false);
$pedidos = mostrarPedidos(null, true);
$totalVentas = 0;

//CREAR UN LISTADO CON LAS CATEGORIAS
$categoriasListado = [];
foreach ($categorias as $cat) {
    $categoriasListado[$cat['id']] = $cat['nombre'];
}
...
<script>
    // TOMAR ID DEL USUARIO ACTUAL Y TODOS LOS PRODUCTOS EN JAVASCRIPT
...
<div class="min-h-screen bg-fashion-gray flex">
    ...
    <aside class="w-96 bg-white shadow-xl hidden md:block sticky top-24 h-[calc(100vh-6rem)] z-10 overflow-y-auto p-6">
        ...
        <h1 class=" font-editorial text-2xl italic text-fashion-black mb-8">
            Panel
            <?= $_SESSION['usuario']['rol'] === 'admin' ? 'Admin' : 'Empleado' ?>
        </h1>
        <nav class="space-y-2">
            <button onclick="cambiarPestaña('dashboard')"
                class="nav-item w-full text-left px-4 py-3 rounded-lg text-sm uppercase tracking-widest font-semibold text-gray-500 hover:bg-fashion-gray hover:text-fashion-black transition-colors flex items-center"
                data-tab="dashboard">
    ...
    <main class="flex-1 p-8 pt-24">
        ...
        <section id="seccion-dashboard" class="tab-content block">
            <h2 class="font-editorial text-4xl italic text-fashion-black mb-8">Resumen General</h2>
        ...
        <section id="seccion-pedidos" class="tab-content hidden">
            <div class="flex justify-between items-center mb-8">
                <h2 class="font-editorial text-4xl italic text-fashion-black">Gestión de Pedidos</h2>
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4 font-bold text-fashion-black">
                                        ...
                                        <?php if ($pedido['activo'] == 0): ?>
                                            <span class="block text-[9px] text-red-600 uppercase tracking-widest mt-1">
                                                Eliminado
                                            </span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-500">
                                            <?= htmlspecialchars($pedido['usuario_email'] ?? 'email desconocido') ?>
                                        </div>
                                    </td>
        ...
        <section id="seccion-productos" class="tab-content hidden">
            <div class="flex justify-between items-center mb-8">
                <h2 class="font-editorial text-4xl italic text-fashion-black">Gestión de Productos</h2>
                        ...
                        <?php else: ?>
                            <?php foreach ($productos as $producto): ?>
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500">
                                        <?= htmlspecialchars($categoriasListado[$producto['categoria_id']] ?? 'Sin categoría') ?>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span
                                            class="px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider 
        ...
        <section id="seccion-categorias" class="tab-content hidden">
            <div class="flex justify-between items-center mb-8">
                <h2 class="font-editorial text-4xl italic text-fashion-black">Gestión de Categorías</h2>
        ...
        <?php if ($_SESSION['usuario']['rol'] === 'admin'): ?>
            ...
            <section id="seccion-usuarios" class="tab-content hidden">
                <div class="flex justify-between items-center mb-8">
                    <h2 class="font-editorial text-4xl italic text-fashion-black">Gestión de Usuarios</h2>
...
<!-- MODAL CATEGORÍA DE CREAR Y EDITAR -->
...
<!-- MODAL PEDIDO DE CREAR Y EDITAR -->
                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-100">
                                <th class="px-6 py-3 text-xs uppercase tracking-widest font-bold text-gray-500">
                                    Producto
                                </th>
                                <th
                        ...
                        <tfoot>
                            <tr class="bg-gray-50 font-bold border-t-2 border-fashion-black">
                                <td colspan="3" class="px-6 py-4 text-right uppercase tracking-widest text-xs">
                                    Total del Pedido
                                </td>
...
<div id="modal-notificacion" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4"
    ...
    <div class="bg-white rounded-lg shadow-2xl w-[300px] p-6 text-center transform transition-all scale-100 relative">
        <div id="icono-notificacion" class="mb-4 text-4xl flex justify-center"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
                ...
                <div class="flex flex-col gap-6 relative z-30 pointer-events-auto">
                        ...
                        <div class="space-y-2">
                            ...
                            <div
                                ...
                                <input type="number" id="precio-producto" name="precio" required step="0.50" min="0"
                                    value="0.00"
                                    class="w-full bg-transparent border-none px-4 py-3 focus:ring-0 text-fashion-black font-bold appearance-none">
                            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div
                            class="flex items-center bg-gray-50 border border-gray-200 rounded-lg overflow-hidden focus-within:border-fashion-black transition-colors">
                            <input type="number" id="descuento-producto" name="descuento" value="0" min="0" max="100"
                                step="1"
                    ...
                    <div class="col-span-2 grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div id="contenedor-tallas"
                                class="space-y-3 p-4 bg-gray-50 rounded-lg border border-gray-200 relative z-50"> </div>
